...
const DateSelector = ({ date, setDate }) => {
  ...
  return (
    <div>
        <button className='inline-flex items-center gap-2 text-[13px] font-medium text-sky-600 bg-sky-200/40 hover:bg-sky-200/79 rounded px-2 py-1 cursor-pointer' onClick={() => {
        ...
        {openDatePicker&& (<div className='overflow-y-scroll p5 bg-sky-50/80 rounded-lg relative pt-9'>
